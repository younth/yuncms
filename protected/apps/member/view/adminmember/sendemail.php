...
$(function ($) { 
   ...
   //表单验证
	var items_array = [
		{ name:"title",simple:"邮件标题",focusMsg:''},
		{ name:"content",simple:"邮件内容",focusMsg:''},
	];
...
<div class="list_head_m">
           <div class="list_head_ml">当前位置：【发送{$t_name}】</div>
        </div>
