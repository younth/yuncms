<div class="mem_comlist">
        <div class="mem_comlist_a" >        
            <a href="{url('profile/user',array('id'=>$result['membermid']['id']))}" target="_blank"><img width="40px" src="{$result['avatar']}" /></a>
        </div>
<div class="mem_comlist_b">
    <a href="{url('profile/user',array('id'=>$result['membermid']['id']))}">{$result['membermid']['uname']}</a>回复<a href="{url('profile/user',array('id'=>$result['memberfmid']['id']))}">{$result['memberfmid']['uname']}</a>:{$result['feed_content']}</h4>
