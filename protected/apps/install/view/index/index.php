...
<div class="install_right">
  ...
  <h2>环境要求</h2>
  <p>
<strong>运行环境需求</strong><br>
可用的 web服务器（如 Apache，nginx，IIS 等）<br>
...
<br><strong>二、协议许可的权利 </strong><br>

    1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。<br> 
    2、您可以在协议规定的约束和限制范围内修改 Yuncms 源代码(如果被提供的话)或界面风格以适应您的网站要求。<br> 
...
<div class="install_btn"> <input class="button" value="同意上述协议进入下一步" type="button" onClick="window.location.href = '{url('index/env')}'"></div>
</div>