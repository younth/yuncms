...
{//类定义开始
    ...
    // 允许上传的文件后缀
    public $allowExts = array('jpg','bmp','gif','png','flv','mp4','mp3','wma','mp4','7z','zip','rar','ppt','txt','pdf','xls','doc','swf');
     ...
     * @access public
     +----------------------------------------------------------
     */
    public function __construct($savePath='',$maxSize='',$allowExts='',$allowTypes='',$saveRule='')
    {
            ...
            if(false !== $image) {
				...
				if(file_exists(dirname(__FILE__).'/Image.class.php'))
				{
					...
					for($i=0,$len=count($thumbWidth); $i<$len; $i++) {
						...
						Image::thumb($filename,$thumbname,'',$thumbWidth[$i],$thumbHeight[$i],$this->thumbType,true);
					}
