...
class Image {
	...
	//生成缩略图
    static public function thumb($image, $thumbname, $domain = 'public', $maxWidth=200, $maxHeight=50,$thumbtype=1,$interlace=true) {
        // 获取原图信息
		...
		if($info !== false) {
			...
			switch ($thumbtype) {
				...
				case 2://等比缩小
			       ...
			       if($scale<1) { // 缩略图尺寸
				      $width = $saeWidth = (int)($srcWidth*$scale);
				      $height = $saeHeight= (int)($srcHeight*$scale);
			       }
				    break;
				default:
					# code...
