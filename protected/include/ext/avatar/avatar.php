...
$config = array(
    ...
    'avatardir' => 'images',        //存储头像的文件夹（相对于本文件的位置而言），开头和结尾请不要加反斜杆
    'authkey' => 'safsdfsda5643dgsdfgrew',          //通讯密钥，必须填写，否则脚本无法运行！
    'debug' => false,    //开启debug记录
    'uploadsize' => 1024*5,   //上传图片文件的最大值，单位是KB
    'uc_api' => 'http://localhost/yuncms/protected/include/ext/avatar',       //运行该脚本的网址，末尾请不要加反斜杠
     //'uc_api' => 'http://www.kjjlpt.com/face',
	'imgtype' => array(1 => '.gif', 2 => '.jpg', 3 => '.png'),  //允许上传的类型
);
...
if(method_exists($controller, $action)){
    ...
    */
    if(is_array($result)){
     ...
     echo $results;
    //$smarty->assign('photo',$results);
    //$smarty->display('myphoto.html');
